...
const TABLE_HEAD = [
  { id: 'im:name', label: 'Name', alignRight: false },
  { id: 'id:artist', label: 'Artist', alignRight: false },
  { id: 'category', label: 'Category', alignRight: false },
  { id: 'im:price', label: 'Price', alignRight: false },
];
              ...
              <Table>
                ...
                <TableBody>
                  {filteredAlbums.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row: Entry) => {
                    ...
                    const artist = row['im:artist'].label;
                    ...
                    return (
                      <TableRow hover key={id + name} tabIndex={-1} role="checkbox" selected={isSelectedUser}>
                        <TableCell padding="checkbox">
                          <Checkbox checked={isSelectedUser} onChange={(event) => handleClick(event, id)} />
                        </TableCell>
